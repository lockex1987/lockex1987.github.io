...
$strOk = '<i class="fa fa-check text-success"></i>';
$strFail = '<i style="color: red" class="fa fa-times text-danger"></i>';
...
<head>
    ...
    <title>Server Requirements - Laravel PHP Framework</title>
...
<article>
    <div class="logo mb-3">
        ...
        <img src="https://laravel.com/img/logotype.min.svg" class="ml-3"/>
    </div>
    ...
    <div class="font-size-1.5 mb-3 text-info">
        Server requirements
    </div>
