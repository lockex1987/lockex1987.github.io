 ...
 *
 * @param {bool} escape whether to escape or strip undesirable content.
 * @param {map} tags of allowed tag-attribute-attribute-parsers.
 * @param {array} css of allowed css elements.
 * @param {array} urls of allowed url scheme
 */
...
HtmlWhitelistedSanitizer.makeUrlSanitizer = function (urls) {
    return function (str) {
        if (!str) {
            return '';
        }
