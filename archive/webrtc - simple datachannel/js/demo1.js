new Vue({
    ...
    methods: {
        setupConnections() {
            ...
            this.remoteConnection.onicecandidate = (evt) => {
                ...
                if (evt.candidate) {
                    ...
                    // Local thêm ICE candiate
                    this.handleIceCandidate(this.localConnection, this.remoteIceCandidate);
                }
            };
        },
        ...
        async connectPeers() {
            ...
            // Local nhận answer
            await this.handleAnswer(this.localConnection, this.remoteDescription);
        },

        handleIceCandidate(connection, iceCandidate) {
            connection.addIceCandidate(new RTCIceCandidate(JSON.parse(iceCandidate)));
        },
        ...
        async handleAnswer(connection, answer) {
            await connection.setRemoteDescription(new RTCSessionDescription(JSON.parse(answer)));
        },
